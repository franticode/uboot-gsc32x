...
#ifndef __GODSON_GSC32_ETH_H_
#define __GODSON_GSC32_ETH_H_

#include <mach/gsc32.h>

/* Ethernet */
struct gsc32_ectl_regs {
	struct gsc32_reg_atomic con1; /* 0x00 */
	struct gsc32_reg_atomic con2; /* 0x10 */
	struct gsc32_reg_atomic txst; /* 0x20 */
	struct gsc32_reg_atomic rxst; /* 0x30 */
	struct gsc32_reg_atomic ht0;  /* 0x40 */
	struct gsc32_reg_atomic ht1;  /* 0x50 */
	struct gsc32_reg_atomic pmm0; /* 0x60 */
	struct gsc32_reg_atomic pmm1; /* 0x70 */
	struct gsc32_reg_atomic pmcs; /* 0x80 */
	struct gsc32_reg_atomic pmo;  /* 0x90 */
	struct gsc32_reg_atomic rxfc; /* 0xa0 */
	struct gsc32_reg_atomic rxwm; /* 0xb0 */
	struct gsc32_reg_atomic ien;  /* 0xc0 */
	struct gsc32_reg_atomic irq;  /* 0xd0 */
	struct gsc32_reg_atomic stat; /* 0xe0 */
};

struct gsc32_mii_regs {
	struct gsc32_reg_atomic mcfg; /* 0x280 */
	struct gsc32_reg_atomic mcmd; /* 0x290 */
	struct gsc32_reg_atomic madr; /* 0x2a0 */
	struct gsc32_reg_atomic mwtd; /* 0x2b0 */
	struct gsc32_reg_atomic mrdd; /* 0x2c0 */
	struct gsc32_reg_atomic mind; /* 0x2d0 */
};

struct gsc32_emac_regs {
	struct gsc32_reg_atomic cfg1; /* 0x200*/
	struct gsc32_reg_atomic cfg2; /* 0x210*/
	struct gsc32_reg_atomic ipgt; /* 0x220*/
	struct gsc32_reg_atomic ipgr; /* 0x230*/
	struct gsc32_reg_atomic clrt; /* 0x240*/
	struct gsc32_reg_atomic maxf; /* 0x250*/
	struct gsc32_reg_atomic supp; /* 0x260*/
	struct gsc32_reg_atomic test; /* 0x270*/
	struct gsc32_mii_regs mii;    /* 0x280 - 0x2d0 */
	struct gsc32_reg_atomic res1; /* 0x2e0 */
	struct gsc32_reg_atomic res2; /* 0x2f0 */
	struct gsc32_reg_atomic sa0;  /* 0x300 */
	struct gsc32_reg_atomic sa1;  /* 0x310 */
	struct gsc32_reg_atomic sa2;  /* 0x320 */
};
 ...
 * ref: GSC32 Family Reference Manual Table 35-7
...
#define GSC32_MDIO_NAME "GSC32_EMAC"

int gsc32_mdio_init(const char *name, ulong ioaddr);

#endif /* __GODSON_GSC32_ETH_H_*/
