...
static int gsc32_sdhci_probe(struct udevice *dev)
{
...
static const struct udevice_id gsc32_sdhci_ids[] = {
	{ .compatible = "godson,gsc32-sdhci" },
	{ }
};

U_BOOT_DRIVER(gsc32_sdhci_drv) = {
	.name			= "gsc32_sdhci",
	.id			= UCLASS_MMC,
	.of_match		= gsc32_sdhci_ids,
	.probe			= gsc32_sdhci_probe,
